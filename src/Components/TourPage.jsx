        ...
        <div className="bg-emerald-200 rounded-2xl font-sans hover:shadow-2xl hover:shadow-zinc-400 duration-300 hover:scale-105 transition-transform">
            ...
            <div className="p-5 space-y-2">
                ...
                <div className="flex justify-between it">
                    ...
                    <button className="bg-green-500 text-white p-3 font-semibold rounded-b-2xl w-fit hover:bg-green-600 transition-all duration-300 cursor-pointer" onClick={handleOnBook}>Book Now</button>
                </div>
            </div>
