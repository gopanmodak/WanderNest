  ...
  return (
    <div className="bg-white shadow-md backdrop-blur-xl fixed top-0 left-0 w-full z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        {menuOpen && (
          <div
            className={`absolute top-20 left-0 w-full bg-white shadow-md flex flex-col items-center gap-5 py-5 pb-2 md:hidden transition-transform duration-300 ${menuOpen ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'}`}
          >
            ...
            <NavLink to="/visa" onClick={() => setMenuOpen(false)}>
              Visa
            </NavLink>
            ...
            <NavLink to="/hajj-umrah" onClick={() => setMenuOpen(false)}>
              Hajj And Umrah
            </NavLink>
